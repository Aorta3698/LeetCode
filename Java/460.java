https://leetcode.com/problems/lfu-cache/discuss/1853951/Java-or-Doubly-Linked-List-and-HashMap-or-Comments!
class LFUCache {
    ...
    // private void print(){
    //     Bucket cur = bucketHead.next;
    //     System.out.println("BUCKET LIST INFO:");
    //     while(cur != null){
    //         Item head = cur.head.next;
    ...
    //         System.out.print(itemMap.get(key).val + ", ");
    //     }

    //     System.out.println("\nBUCKET MAP INFO: ");
    //     for (int count : bucketMap.keySet()){
    //         if (count == 0) continue;
    //         System.out.println(count + ": " + bucketMap.get(count).sz);
    //     }
    //     System.out.print("\n");
    // }
