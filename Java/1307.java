https://leetcode.com/problems/verbal-arithmetic-puzzle/discuss/2368096/Java-or-Build-Digit-by-Digit-From-the-End-or-Explained-w-Diagram
class Solution {
    ...
    private boolean ok(int d, int c, int[] a, int[] b){
        return a[c] == -1 && b[d] == -1
            || a[c] ==  d && b[d] == c;
    }
}
